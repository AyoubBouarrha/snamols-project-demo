...
public class QuestionEvaluationController {
    ...
    public boolean addQuestionEvaluation(@RequestBody final QuestionEvaluation questionEvaluation,HttpServletRequest request) {
    ...
    public final boolean deleteQuestionEvaluation(@PathVariable(value = "id") final long id,HttpServletRequest request) {
        if(Connection.currentUser(request) == null || !Connection.currentUser(request).getRole().equals("Prof"))
            throw  new SPIException(SpiExceptionCode.NOT_ENOUGH_RIGHT,"access denied");
        try {
    ...
    public List<Question> getQuestionsNotAffected(@PathVariable(value = "idEvaluation") int idEvaluation, @PathVariable(value = "idRubrique") int idRubrique,HttpServletRequest request) {
        if(Connection.currentUser(request) == null || !Connection.currentUser(request).getRole().equals("Prof"))
            throw  new SPIException(SpiExceptionCode.NOT_ENOUGH_RIGHT,"access denied");
    ...
    public List<QuestionEvaluation> getAllQuestionsEvaluations(HttpServletRequest request) {
        if(Connection.currentUser(request) == null || !Connection.currentUser(request).getRole().equals("Prof"))
            throw  new SPIException(SpiExceptionCode.NOT_ENOUGH_RIGHT,"access denied");
    ...
    public final QuestionEvaluation getQuestionEvaluation(@PathVariable(value = "idquestionEvaluation") final long idQuestionEvaluation,HttpServletRequest request) {
        if(Connection.currentUser(request) == null || !Connection.currentUser(request).getRole().equals("Prof"))
            throw  new SPIException(SpiExceptionCode.NOT_ENOUGH_RIGHT,"access denied");
    ...
    public List<QuestionEvaluation> getQuestionsAffected(@PathVariable(value = "idEvaluation") int idEvaluation, @PathVariable(value = "idRubrique") int idRubrique,HttpServletRequest request) {
        if(Connection.currentUser(request) == null || !Connection.currentUser(request).getRole().equals("Prof"))
            throw  new SPIException(SpiExceptionCode.NOT_ENOUGH_RIGHT,"access denied");
